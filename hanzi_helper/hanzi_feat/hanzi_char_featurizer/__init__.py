...
from hanzi_helper.hanzi_feat.hanzi_char_featurizer.featurizers.four_corner import FourCorner
from hanzi_helper.hanzi_feat.hanzi_char_featurizer.featurizers.pinyin_parts import PinYinParts
